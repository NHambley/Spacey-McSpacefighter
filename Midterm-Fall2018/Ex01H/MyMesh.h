...
public:
	...
	*/
	...
	/*
	USAGE: Adds 6 vector3's of a_v3Color to the list of colors in the mesh
	ARGUMENTS:
	-	vector3 a_v3Color -> color to quadruplicate
	OUTPUT: ---
	*/
...
#pragma endregion
	...
	/*
	USAGE: Returns the list of vertex positions used to create this mesh
	ARGUMENTS: ---
	OUTPUT: vector of vec3's that make the mesh
	*/
